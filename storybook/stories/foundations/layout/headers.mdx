...
import * as HeaderStories from './headers.story';
...
{/* When you want the raw story */}
<Story of={ HeaderStories.HeaderExampleLowDensity } />

{/* The story with "chrome". For more configuration options see https://storybook.js.org/docs/api/doc-blocks/doc-block-canvas */}
<Canvas of={ HeaderStories.HeaderExampleLowDensity } />
...
<Story of={ HeaderStories.HeaderExampleHighDensity } />
